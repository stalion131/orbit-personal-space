import { priorities, createTask, TaskError, type Priority } from '@/lib/tasks';
...
export async function POST(request: Request) {
  try {
    ...
    const next = createTask(data.id, data.description.trim(), sphere.id, data.directionId as string|null, data.dueDate as string|null, Number(data.queue), data.priority as Priority);
